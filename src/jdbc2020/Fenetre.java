...
public class Fenetre extends JFrame implements ActionListener, ItemListener {
    ...
    public Fenetre() {
        ...
        //Adapter l'affichage de frame selon la taille
        super.pack();
    ...
    private void remplirRequetes() {
        ...
        maconnexion.ajouterRequete("SELECT * FROM Dept");

        // Requêtes d'insertion
        maconnexion.ajouterRequete("INSERT INTO Dept (deptno,dname,loc) VALUES (100,'ECE','Paris');");

        // Requêtes de modification
        maconnexion.ajouterRequete("UPDATE Dept SET loc='Eiffel' WHERE loc='Paris';");

        // Requêtes de suppression
        maconnexion.ajouterRequete("DELETE FROM Dept WHERE loc='Eiffel';");
    ...
    public ArrayList<String> afficherRes(String requeteSelectionnee) throws SQLException {
        ...
        try {
            ...
            //AJOUTER:
            if (requeteSelectionnee.charAt(0)=='I' || requeteSelectionnee.charAt(0)=='D' || requeteSelectionnee.charAt(0)=='U' )
            {
                System.out.println("UPDATE BEFORE");
                maconnexion.executeUpdate(requeteSelectionnee);
                pleutre++;
                System.out.println("pleutre :" +  pleutre);
                System.out.println("UPDATE AFTER");
                fenetreRes.setText("");
                fenetreRes.append("UPDATE FAITE");
            }
